...
public interface GestorExpendientes {
	...
	@PostFilter("(hasRole('ROLE_AGENTE') and not filterObject.clasificado) or (hasAnyRole('ROLE_AGENTE_ESPECIAL','ROLE_DIRECTOR') and not filterObject.informe.contains(principal.username))")
